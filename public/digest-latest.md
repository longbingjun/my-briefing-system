# My Briefing · 2026-09-20

12 个活跃信源 -> 4145 条扫描 -> 7 条今日值得看
预计阅读 12 分钟，节省约 172.5 小时。

## 今日导读

- **官方 AI 实验室与公司信号**：官方 AI 实验室与公司信号 本期匹配 1603 篇文章，重点集中在 评测/安全、Agent 工作流、推理训练/测试时计算。建议先看《甲骨文烧数十亿美元帮其他企业运行 AI，公司内部推广 AI 却并不顺利》。
- **AI Agents**：AI Agents 本期匹配 808 篇文章，重点集中在 Agent 工作流、后训练/对齐、评测/安全。建议先看《Claude Cowork and chat are now one Claude》。
- **推理训练与强化学习**：推理训练与强化学习 本期匹配 501 篇文章，重点集中在 评测/安全、预训练/模型架构、推理训练/测试时计算。建议先看《OpenAI 研究员示警：AI 能力越强，越容易“隐藏内心想法”》。
...
- [100] [刚刚，Claude Code大重构！内部3万Agent管理技术免费开放](https://www.qbitai.com/2026/09/491711.html) · 量子位 · 1 min
  Git白学了？？？
- [99] [苹果详解 Safari 27 浏览器升级：解决阅读“乱跳”，修复 844 个问题](https://www.ithome.com/1/004/056.htm) · IT之家 · 2 min
  IT之家 9 月 18 日消息，苹果公司昨日（9 月 17 日）更新 WebKit 博文，详细介绍了 Safari 27 系统带来的诸多新功能 / 新特性， 包括支持 MCP 协议，以及修复 844 个问题等。 对于开发者而言，Safari 27 浏览器最主要变化在于新增支持 MCP（Model Context Protocol）服务器支持，让 Claude Code、Codex 等 AI 工具能够控制浏览器窗口，读取 DOM 结构、网络请求、屏幕截图和控制台输出，从而帮助开发者更快地调试网站。 对于用户而言，Safari 27 新增滚动锚定（Scroll Anchoring）功能，当用户正在读文章时，页面上方延迟加载的图片、广告、评论或推荐模块，不会再把正在看的段落往下推。 IT之家翻译官方相关介绍如下： 许多网站会在用户阅读或浏览内容时向页面注入新内容。这些新内容通常会出现在用户当前视线上方，例如图片、广告或评论。过去这会导致用户正在阅读的内容突然被向下推移，造成页面跳转到随机位置，令人感到困惑。 现在 Safari 27.0 支持滚动锚定，它会调整滚动位置， 让内容保持在插入内容之前的位置。 滚动锚点由 CSS 属性 overflow-anchor 控制，默认值为 auto。如果开发者有特殊需求需要禁用滚动锚点，可以使用 overflow-anchor: none。 在实际场景中，用户在浏览新闻、论坛、长篇博客、带广告的网站时， 在启用该功能后，不会再出现读到一半，页面忽然“跳”到别处的体验问题。 在 Bug 修复方面，苹果表示在 WWDC 2026 活动中，官方为 Safari 27.0 修复了 525 个问题，而在博文中， 苹果公司宣布 Safari 27.0 最终修复 844 个问题，增幅 60.76%。
- [99] [Qoder 福利：10 月前阿里千问 Qwen3.8-Flash 免费用，每日登录还能领 100 Credits](https://www.ithome.com/1/004/011.htm) · IT之家 · 2 min
  IT之家 9 月 18 日消息，阿里 Qoder 官方今日宣布，Qwen3.8-Flash 模型在 Qoder 平台限时免费（活动从 9 月 18 日 10:00 持续至 9 月 30 日 23:59:59）。 活动期间，Qwen3.8-Flash 计费系数由 0.1× 降至 0.0×，每次调用不扣 Credits。用户无需领取免费资格，打开 Qoder 桌面端并在模型选择器中选择该模型即可使用。 在此基础上，Qoder 还推出每日登录奖励。每天 10:00 开放新一轮领取，至次日 10:00 前可领（每个账号每轮可领一次 100 通用 Credits，错过不补），每笔奖励自领取之日起 30 天有效。 值得一提的是，未到期的额度可以累积。奖励计入 Add-on Credits，可在 Qoder、Qoder IDE、Qoder JetBrains 插件、Qoder CLI、QoderWake、Qoder Cloud Agents、移动端及网页版使用。 参与资格覆盖国际版体验版、Pro 试用期、Pro、Pro+、Ultra 用户，以及 CN 体验版、专业版、高级版、旗舰版及会员卡用户，包含免费和试用期用户。 有需要的用户只需现在打开 Qoder 桌面端，点击左下角用量面板中的礼物图标即可。Qoder 表示，每日登录奖励暂时没有结束时间，领取不改变订阅等级、会员卡权益或功能权限。 据官方介绍，Qwen3.8-Flash 擅长代码编写、长文档处理、图像理解和工具调用。在 Qoder 上，该模型可用于现有项目功能升级、搭建网站或应用、数据可视化分析报告及课题研究等场景。 免费期间，套餐内额度和每日奖励可留给其他模型使用。Qoder 国际版与 Qoder CN 的新老个人用户均可参加。免费活动结束后，Qwen3.8-Flash 将按届时公示系数计费，其他模型或档位仍按各自规则执行。
...
- 官方 AI 实验室与公司信号：本周 404，今日 +55，官方 AI 实验室与公司信号 本期匹配 1603 篇文章，重点集中在 评测/安全、Agent 工作流、推理训练/测试时计算。建议先看《甲骨文烧数十亿美元帮其他企业运行 AI，公司内部推广 AI 却并不顺利》。
- AI Agents：本周 242，今日 +21，AI Agents 本期匹配 808 篇文章，重点集中在 Agent 工作流、后训练/对齐、评测/安全。建议先看《Claude Cowork and chat are now one Claude》。
- 推理训练与强化学习：本周 138，今日 +7，推理训练与强化学习 本期匹配 501 篇文章，重点集中在 评测/安全、预训练/模型架构、推理训练/测试时计算。建议先看《OpenAI 研究员示警：AI 能力越强，越容易“隐藏内心想法”》。
- 预训练：本周 99，今日 +0，预训练 本期匹配 387 篇文章，重点集中在 预训练/模型架构、后训练/对齐、推理训练/测试时计算。建议先看《DeepSeek V4.1 Flash 模型正式发布：全面超越 V4 Pro、原生多模态视觉理解，API 定价下调》。
- 后训练与对齐：本周 73，今日 +4，后训练与对齐 本期匹配 274 篇文章，重点集中在 后训练/对齐、预训练/模型架构、评测/安全。建议先看《Anthropic 揭示“AI 训练 AI”新方法，比人类研究员成本更低、速度更快》。
- 编程 Agent：本周 31，今日 +6，编程 Agent 本期匹配 147 篇文章，重点集中在 Agent 工作流、评测/安全、预训练/模型架构。建议先看《Claude Cowork and chat are now one Claude》。
- AI 评测与安全：本周 385，今日 +12，AI 评测与安全 本期匹配 1408 篇文章，重点集中在 评测/安全、推理训练/测试时计算、预训练/模型架构。建议先看《Auto mode is now the default in Claude Code for Pro, Max, and Team plans》。
- AI 产品化：本周 338，今日 +23，AI 产品化 本期匹配 1202 篇文章，重点集中在 评测/安全、推理训练/测试时计算、Agent 工作流。建议先看《Some thoughts on the Navier–Stokes Millennium Prize Problem》。
- 数据分析与指标体系：本周 327，今日 +25，数据分析与指标体系 本期匹配 1309 篇文章，重点集中在 推理训练/测试时计算、预训练/模型架构、数据与指标。建议先看《Understanding ChatGPT Work》。
- AI 基础设施与算力：本周 237，今日 +12，AI 基础设施与算力 本期匹配 917 篇文章，重点集中在 后训练/对齐、预训练/模型架构、推理训练/测试时计算。建议先看《中国电信开源首个全栈国产轻量级智能体大模型 Xing4.0-29B-A4B》。
- 成本管理与 FinOps：本周 213，今日 +15，成本管理与 FinOps 本期匹配 775 篇文章，重点集中在 评测/安全、预训练/模型架构、Agent 工作流。建议先看《Some thoughts on the Navier–Stokes Millennium Prize Problem》。
- 科技圈动态：本周 98，今日 +5，科技圈动态 本期匹配 346 篇文章，重点集中在 官方/科技圈信号、数据与指标、评测/安全。建议先看《How To Write With An LLM》。
